...
class PredNetAdditive(PredNet):
    ...
    """
    def __init__(self, R_channels, A_channels, nt=5, class_weight=1, rec_weight=0, noise_type='gaussian', noise_intensities=None):
        super().__init__(R_channels, A_channels, nt, class_weight=class_weight, rec_weight=rec_weight, noise_type=noise_type, noise_intensities=noise_intensities)
